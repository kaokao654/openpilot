...
class LongitudinalPlanner:
  ...
  @staticmethod
  def parse_model(model_msg, model_error, v_ego,enable_turn_slowdown,turn_slowdown_factor):
    ...
    if enable_turn_slowdown:
      ...
      max_v = turn_slowdown_factor * np.sqrt(max_lat_accel / (np.abs(curvatures) + 1e-3)) - 2.0
